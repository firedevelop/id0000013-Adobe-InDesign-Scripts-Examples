...
for(AppendixA=0;AppendixA<myArr3.length;AppendixA++){
	for(AppendixB=0;AppendixB<myArr4.length;AppendixB++){
		if(myParas[i].appliedParagraphStyle.name == "Chapter "+[AppendixA]+"."+[AppendixB]){
			myParas[i].parentTextFrames[0].parentPage.appliedMaster = myDocument.masterSpreads.item("C"+[AppendixA]+"-Chapter");}}}
