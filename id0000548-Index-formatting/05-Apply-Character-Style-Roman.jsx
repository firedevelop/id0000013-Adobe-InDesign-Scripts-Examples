...
for ( c = 0; c < myCodes.length; c++) {         
    ...
    var characterStyleRoman = app.documents[0].characterStyles.itemByName( "Roman" );
    ...
    for ( f = 0; f < F; f++) {    
        if ((myFound[f].appliedParagraphStyle == IndexLevel01Roman ||
            ...
            myFound[f].appliedCharacterStyle = characterStyleRoman;    // uncomment this line to use Character Style
